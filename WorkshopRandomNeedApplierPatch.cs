...
namespace Mods.MoreModLogs {
  ...
  static class WorkshopRandomNeedApplierPatch {
    ...
    public static MethodBase TargetMethod() {
      var sls = AccessTools.TypeByName("Timberborn.NeedApplication.WorkshopRandomNeedApplier");
      return sls.Method("Awake");
    }
    ...
    static void Postfix(BaseComponent __instance, BaseComponent ____workshopRandomNeedApplierSpec) {
      ...
      var count = (int)effects.Property("Count").GetValue();
      if (count == 0) {
