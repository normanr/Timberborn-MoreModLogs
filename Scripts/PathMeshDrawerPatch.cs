...
[HarmonyPatch(typeof(PathMeshDrawer))]
[HarmonyPatch(nameof(PathMeshDrawer.Add))]
public static class PathMeshDrawerPatch {
  ...
  public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions) {
    ...
    if ((Nothing != PathMeshConnectionKeys.Nothing) ||
        ...
        (Building != PathMeshConnectionKeys.Building) ||
        (AlternativeBuilding != PathMeshConnectionKeys.AlternativeBuilding)) {
