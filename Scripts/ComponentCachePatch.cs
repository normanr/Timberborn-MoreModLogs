...
static class ComponentCachePatch {
  ...
  public static IEnumerable<MethodBase> TargetMethods() {
    yield return SymbolExtensions.GetMethodInfo(() => default(ComponentCache).Initialize);
    yield return SymbolExtensions.GetMethodInfo(() => default(ComponentCache).SetActive);
  }
